...
import imgT from "../../assets/image/l1/png/cafe-image-tinh.png";
import imgP from "../../assets/image/patterns/cafe-pattern.png";

const defaultCountries = [
  { value: "hp", label: "Hải Phòng" },
  { value: "hn", label: "Hà Nội"},
  { value: "dn", label: "Đà Nẵng"},
  { value: "cn", label: "Cần Thơ" },
          ...
          <div className="row position-relative align-items-center">
            ...
            >
              <h1 className="font-size-11 mb-12 pr-md-30 pr-lg-0">
                CHÀO MỪNG BẠN ĐẾN VỚI NGÔI NHÀ CÀ PHÊ CỦA CHÚNG TÔI.
              </h1>
              <div className="">
                {/* <!-- .search-form --> */}
            ...
            >
              <div className=" ml-xxl-23 ml-xl-12 ml-md-7">
                 {/* sửa ảnh banner ở trang chủ  */}
                <img src={imgT} alt="" className="w-100" />
              </div>
            </div>
            {/* <!-- ./Hero Right Image --> */}
          </div>
