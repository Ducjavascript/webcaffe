  ...
  return (
    <>
      ...
      <div className="widgets mb-11">
        <h4 className="font-size-6 font-weight-semibold mb-6">Sắp xếp</h4>
        <ul className="list-unstyled filter-check-list">
            <li className="mb-2">
                <Check>Hot</Check>
            </li>
          <li className="mb-2">
            <Check>Phổ biến</Check>
          </li>
          <li className="mb-2">
            <Check>Giá tốt nhất</Check>
          </li>
          <li className="mb-2">
            <Check>Giảm giá</Check>
          </li>
          <li className="mb-2">
            <Check>Đánh giá xếp loại</Check>
          </li>
        </ul>
      </div>
      <div className="widgets mb-11 ">
        ...
        <div className="widgets mb-11">
            <h4 className="font-size-6 font-weight-semibold mb-6">Thương Hiệu</h4>
            <ul className="list-unstyled filter-check-list">
                <li className="mb-2">
                    <Check>Nest Cafe</Check>
                </li>
                <li className="mb-2">
                    <Check>Cafe Trung nguyên</Check>
                </li>
                <li className="mb-2">
                    <Check>Cafe chồn Đắc Lắk</Check>
                </li>
                <li className="mb-2">
                    <Check>Cafe Dà Lạt</Check>
                </li>
            </ul>
        </div>
      <div className="widgets mb-11">
